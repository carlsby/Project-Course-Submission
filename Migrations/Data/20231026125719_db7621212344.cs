...
{
    /// <inheritdoc />
    public partial class db7621212344 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewsEntity_Products_ArticleNumber",
                        column: x => x.ArticleNumber,
                        principalTable: "Products",
                        principalColumn: "ArticleNumber",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewsEntity_UserProfileEntity_UserId1",
                        column: x => x.UserId1,
                        principalTable: "UserProfileEntity",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsEntity_ArticleNumber",
                table: "ReviewsEntity",
                column: "ArticleNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsEntity_UserId1",
                table: "ReviewsEntity",
                column: "UserId1");
